        ...
        std::array<RegisterDefinition, 34>{{
            ...
            },
            {
                ...
                [](
                    ...
                    response.persistent = false;
                    response._mutable = false;
                    fill_register_natural32(v_out, foc_cycle_sync.run_status_progress());
                }
            },
            {
                "sync.diag.command_progress",
                [](
                    const uavcan_register_Value_1_0& v_in,
                    uavcan_register_Value_1_0& v_out,
                    RegisterAccessResponse& response
                    ...
                    response.persistent = false;
                    response._mutable = false;
                    fill_register_natural32(v_out, foc_cycle_sync.command_progress());
                }
            },
            {
                "sync.diag.staged_status_progress",
                [](
                    const uavcan_register_Value_1_0& v_in,
                    uavcan_register_Value_1_0& v_out,
                    RegisterAccessResponse& response
                    ...
                    response.persistent = false;
                    response._mutable = false;
                    fill_register_natural32(v_out, foc_cycle_sync.staged_status_progress());
                }
            },
            {
                "sync.diag.status_queue_progress",
                [](
                    const uavcan_register_Value_1_0& v_in,
                    uavcan_register_Value_1_0& v_out,
                    RegisterAccessResponse& response
                    ...
                    response.persistent = false;
                    response._mutable = false;
                    fill_register_natural32(v_out, foc_cycle_sync.status_queue_progress());
                }
            },
            {
                "sync.version",
